              ...
              @if (settings['buttonText']) {
                <div class="hero-actions">
                  @if (settings['buttonLink']) {
                    <a [href]="settings['buttonLink']" class="hero-button">
                      {{ settings['buttonText'] }}
                    </a>
                  } @else {
                    <button class="hero-button">
    ...
    `
      .hero-v2 {
        ...
        background: linear-gradient(
          135deg,
          var(--colors-background-surface, #ffffff) 0%,
          var(--colors-background-surface-hover, #f8fafc) 100%
        );
      ...
      .hero-title {
        ...
        background: linear-gradient(
          to right,
          var(--colors-primary-main, #4f46e5),
          var(--colors-secondary-main, #0ea5e9)
        );
